  ...
  return (
    <div>
      ...
      <aside
        ...
        aria-label="Sidebar"
      >
        <div className="h-full px-3 py-10 overflow-y-auto bg-[#1c2c55] text-white">
          <ul className="space-y-2">
            <li>
              <Link href="/dashboard" passHref>
                <p className="flex items-center p-2 text-base font-normal text-white rounded-lg hover:bg-gray-100 hover:text-gray-900">
                  <svg
                    aria-hidden="true"
            ...
            <li>
              <Link href="/devices" passHref>
                <p className="flex items-center p-2 text-base font-normal text-white hover:text-gray-900 rounded-lg  hover:bg-gray-100 ">
                  <svg
                    aria-hidden="true"
            ...
            <li>
              <Link href="/provision" passHref>
                <p className="flex items-center p-2 text-base font-normal text-white rounded-lg hover:text-black hover:bg-gray-100">
                  <svg
                    aria-hidden="true"
                  ...
                  <span className="flex-1 ml-3 whitespace-nowrap">Provision</span>
                </p>
              </Link>
            </li>
            <li>
